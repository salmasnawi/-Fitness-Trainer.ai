        ...
        <div className="space-y-8">
          ...
          {currentPlan && (
            <div className="relative backdrop-blur-sm border border-border rounded-lg p-6">
              ...
              {/* Radix Tabs */}
              <Tabs.Root defaultValue="workout" className="w-full">
                <Tabs.List className="mb-6 w-full grid grid-cols-2 bg-cyber-terminal-bg border">
                  <Tabs.Trigger
                    value="workout"
                ...
                <Tabs.Content value="workout">
                  <div className="space-y-4">
                    ...
                    <Accordion type="multiple" className="space-y-4">
                      {currentPlan.workoutPlan.exercises.map((exerciseDay: any, index) => {
                        const dayLabel = exerciseDay.day || `Day ${index + 1}`;
                        return (
                          <AccordionItem key={index} value={dayLabel} className="border rounded-lg overflow-hidden">
